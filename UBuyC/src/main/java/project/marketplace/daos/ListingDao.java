...
public class ListingDao {
    ...
    public void createListing(Listing listing) {
        String sql = "INSERT INTO listings (email, title, description, price, image, imageType, listingAge) "
                + "VALUES(:email, :title, :description, :price, :image, :imageType, :listingAge)";
